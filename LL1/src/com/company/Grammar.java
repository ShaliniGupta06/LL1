...
public class Grammar {
    ...
    private void Sd() {
        System.out.println("NT       | Nullable |        First Set        |        Follow Set         ");
        System.out.println("------------------------------------------------------------------------------");
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        String url = "src/com/company/Input.txt";

        Grammar grammar = new Grammar();
        grammar.run(url);

        PrintStream out = new PrintStream(new FileOutputStream("src/com/company/Output.txt"));
        System.setOut(out);
